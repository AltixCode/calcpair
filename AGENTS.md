...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs calcpair`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.calcpair` |
| Scheme | `calcpair://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.calcpair.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/calcpair` |
