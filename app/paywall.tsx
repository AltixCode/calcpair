...
/**
 * One node on the roadmap: a filled, numbered circle sitting on a connecting
 * line, with a "STEP N" micro-label above the claim. `isLast` drops the
 * downward stub of line below the final node so the roadmap doesn't trail
 * off into nothing.
 *
 * Static and non-interactive by design — this is "here is what unlocks",
 * not a wizard the buyer has to step through.
 */
    ...
    <View style={{ flexDirection: "row" }}>
      ...
      <View
        style={{
          ...
          paddingBottom: isLast ? 0 : spacing.xl,
        }}
      >
