...
| CI green on a self-hosted runner | ❌ | failure — run 34977845827, 2026-09-15 |
| `check:release` with real identifiers | ⬜ | not confirmed — CI failure — run 34977845827, 2026-09-15 |
...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.calcpair` |
| App Store Connect record | ✅ | `6812380465` — store name "Calcpair" |
| App Store category | ✅ | HEALTH_AND_FITNESS / UTILITIES |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~5080891075` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~9153279281` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `8929918000` / `7316172178` / `8467892734`; Android `2013155865` / `5526868775` / `9086839834` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proj8b1245ba`, entitlement `entla1726bf645`, offering `ofrnge925003647` |
